...
export const products: ProductDefinition[] = [
  { id:"bioclimatic_double", label:"Bioclimatic Pergola — Double Moving", family:"pergola", details:"Motorized aluminum pergola with moving louvered roof, integrated drainage and optional lighting.", referenceImages:[pergolaReference], dimensions:["width","projection","height"], finishes:["Anthracite","Bronze","White"], options:["Integrated lighting","Vertical ZIP screens","Freestanding","Wall attached"], viewer:"bioclimatic" },
  { id:"rolling_roof", label:"Bioclimatic Pergola — Rolling Roof", family:"pergola", details:"Motorized aluminum pergola with retracting louvered roof and integrated drainage.", referenceImages:[pergolaReference], dimensions:["width","projection","height"], finishes:["Anthracite","Bronze","White"], options:["Integrated lighting","Vertical ZIP screens","Freestanding","Wall attached"], viewer:"bioclimatic" },
  { id:"tilt", label:"Bioclimatic Pergola — Tilt System", family:"pergola", details:"Aluminum pergola with tilting louvers for adjustable sun and ventilation.", referenceImages:[pergolaReference], dimensions:["width","projection","height"], finishes:["Anthracite","Bronze","White"], options:["Integrated lighting","Vertical ZIP screens","Freestanding","Wall attached"], viewer:"bioclimatic" },
  ...
  { id:"flat", label:"Flat Pergola — Premium", family:"pergola", details:"Premium flat-profile retractable fabric pergola with aluminum structure.", referenceImages:[pergolaReference], dimensions:["width","projection","height"], finishes:["Anthracite","Bronze","White"], options:["Integrated lighting","Vertical ZIP screens","Freestanding","Wall attached"], viewer:"fabric" },
  ...
  { id:"ceiling_zip", label:"Ceiling ZIP Screen", family:"screen", details:"Horizontal tensioned fabric shade designed for overhead openings.", referenceImages:[], missingReference:"No verified Ceiling ZIP Screen photograph is in the current catalog.", dimensions:["width","projection"], finishes:["Anthracite","Bronze","White"], options:["Solar fabric","Motorized operation"], viewer:"ceiling_zip" },
  ...
  { id:"sliding_glass", label:"Sliding Glass", family:"glass", details:"Side-stacking sliding glass enclosure with slim aluminum framing.", referenceImages:[], missingReference:"No verified Sliding Glass photograph is in the current catalog.", dimensions:["width","height"], finishes:["Anthracite","Bronze","White"], options:["Clear glass","Locking hardware","Side stacking"], viewer:"sliding_glass" },
